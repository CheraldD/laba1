...
Класс ошибок для шифрования методом Гронсфельда  
...
Используется для указания специфических ошибок при работе с шифром \begin{DoxyWarning}{Предупреждения}
Вывод сообщений об ошибках только на английском языке 
\end{DoxyWarning}
